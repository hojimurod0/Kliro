...
part of 'card_offer_page_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CardOfferPageModel _$CardOfferPageModelFromJson(Map<String, dynamic> json) =>
    CardOfferPageModel(
      content: (json['content'] as List<dynamic>)
          .map((e) => CardOfferModel.fromJson(e as Map<String, dynamic>))
          .toList(),
      totalPages:
...
Map<String, dynamic> _$CardOfferPageModelToJson(CardOfferPageModel instance) =>
    <String, dynamic>{
