...
part of 'car_page_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CarPageModel _$CarPageModelFromJson(Map<String, dynamic> json) => CarPageModel(
...
Map<String, dynamic> _$CarPageModelToJson(CarPageModel instance) =>
    <String, dynamic>{
