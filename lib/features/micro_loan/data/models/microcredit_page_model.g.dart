...
part of 'microcredit_page_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MicrocreditPageModel _$MicrocreditPageModelFromJson(
        Map<String, dynamic> json) =>
    MicrocreditPageModel(
      content: (json['content'] as List<dynamic>)
          .map((e) => MicrocreditModel.fromJson(e as Map<String, dynamic>))
          .toList(),
      totalPages:
...
Map<String, dynamic> _$MicrocreditPageModelToJson(
        MicrocreditPageModel instance) =>
    <String, dynamic>{
