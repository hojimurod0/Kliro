                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isEmailMode ? AppColors.primaryBlue : Colors.transparent,
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                ...
                                color: isEmailMode ? AppColors.white : AppColors.grayText,
                                size: 16,
                              ),
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(vertical: 10),
                          decoration: BoxDecoration(
                            gradient: !isEmailMode ? AppColors.phoneGradient : null,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide: BorderSide(color: AppColors.grayBorder.withOpacity(0.8), width: 1),
                  ),
                  ...
                  onPressed: () {
                    ...
                    if (emailOrPhone.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Iltimos, email yoki telefon raqamini kiriting'),
                    ...
                    if (!isEmailMode) {
                      final cleaned = emailOrPhone.replaceAll(RegExp(r'[^\d]'), '');
